    ...
    >
      <div className="modal bg-white dark:bg-[#2d325c]">
        ...
        <IoCloseCircleOutline style={{height:'25px',width:'25px'}} onClick={handlecancel}/>
          ...
          <div className="form-group">
            <label htmlFor="page">Location</label>
