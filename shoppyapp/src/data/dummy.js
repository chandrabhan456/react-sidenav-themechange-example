...
export const columns = [
  { columnKey: "employeeid", label: "EmployeeId" },
  { columnKey: "employeename", label: "EmployeeName" },
  { columnKey: "phoneno", label: "Phone Number" },
...
export const columns1 = [
  ...
  { Key: "OrderItems", label: "OrderItems" },
...
export const ordersData1 =[{
  employeeid:{label:"1"},
  employeename:{label:"Chandrabhan Gehlot"},
  phoneno:{label:"7023019930"},
  address:{label:"Rathoda wala bera behind new police station Bali,Pali,Rajasthan"},
},
{
  employeeid:{label:"2"},
  employeename:{label:"Raman"},
  phoneno:{label:"3847298106"},
  address:{label:"house no 2 main road "},
},

{
  employeeid:{label:"3"},
  employeename:{label:"Harsh"},
  phoneno:{label:"3839284533"},
  address:{label:"house no 2 main road "},
},
{
  employeeid:{label:"4"},
  employeename:{label:"Benu Ranjan"},
  phoneno:{label:"8848739292"},
  address:{label:"house no 2 main road "},
},

{
  employeeid:{label:"5"},
  employeename:{label:"Ashoka kumar kuri"},
  phoneno:{label:"8372947582"},
  address:{label:"house no 2 main road "},
},

{
  employeeid:{label:"6"},
  employeename:{label:"Amar singh"},
  phoneno:{label:"9282838495"},
  address:{label:"house no 2 main road "},
},
{
  employeeid:{label:"7"},
